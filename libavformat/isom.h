...
typedef struct MOVContext {
    ...
    char* customkey_alg;         //[in]star crypt alg, used to get crypt option
    char* customkey_src;         //[in]star crypt src, used to get crypt key
    AVCustomAlgOpt alg_opt;      //[out]star crypt alg option
    void* alg_ctx;             //[out]star crypt alg context
} MOVContext;
